...
- Access to "GitLab CLI Vault" (vault ID: `wel3z72vxpn4qy5hpadlndpcpm`) and "GitLab.com Service - Platform Engineering - Code Review - gl" (vault ID: `dtcu6jy3l5oksatwvskqquopky`) 1Password vaults. You have to create an [access request](https://handbook.gitlab.com/handbook/business-technology/end-user-services/onboarding-access-requests/access-requests/).
