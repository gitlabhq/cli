...
- `orbit_cli_auto_download`: Automatically download the Orbit CLI binary without prompting (true/false). Environment variables, first one set wins: `GLAB_ORBIT_CLI_AUTO_DOWNLOAD`, `ORBIT_CLI_AUTO_DOWNLOAD`.
- `orbit_cli_auto_run`: Automatically run the Orbit CLI without prompting (true/false). Set to true to skip the confirmation prompt. Environment variables, first one set wins: `GLAB_ORBIT_CLI_AUTO_RUN`, `ORBIT_CLI_AUTO_RUN`.
